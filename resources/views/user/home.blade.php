...
<main>
    <!-- slider-area -->
     <section id="parallax" class="slider-area slider-two fix p-relative">
         ...
         <div class="single-slider slider-bg slider-bg2 d-flex align-items-center" style="background: url(img/slider/slider-bg-3.jpg) no-repeat; ">
                 <div class="container">
                    <div class="row justify-content-center align-items-center">
                         <div class="col-lg-7 col-md-8">
                             <div class="slider-content s-slider-content pt-100">
                                 <h5 data-animation="fadeInUp" data-delay=".4s">Pure & organic Natural products</h5>
                                  <h2 data-animation="fadeInUp" data-delay=".4s">We Are The Best Natural <span> Food</span></h2>
             ...
             <div class="single-slider slider-bg slider-bg2 d-flex align-items-center" style="background: url(img/slider/slider-bg-1.jpg) no-repeat; ">
                 <div class="container">
                    <div class="row justify-content-center align-items-center">
                         <div class="col-lg-7 col-md-8">
                             <div class="slider-content s-slider-content pt-100">
         ...
         <div class="container">
             <div class="row sbox">
                 ...
                 <div class="col-lg-3 col-md-6 col-sm-12">
                     <div class="services-box mb-30 text-center wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                      ...
                      <div class="sr-contner">
                         ...
                         <div class="text">
                             <h3> <a href="services.html">Organic Product</a> </h3>
                         </div>
                      </div>
                 ...
                 <div class="col-lg-3 col-md-6 col-sm-12">
                     <div class="services-box mb-30 text-center wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                         ...
                         <div class="text">
                             <h3> <a href="services.html"> Certified Team Expert</a> </h3>
                         </div>
                      </div>
             ...
             <div class="col-lg-3 col-md-6 col-sm-12">
                     <div class="services-box mb-30 text-center wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                         ...
                         <div class="text">
                             <h3>  <a href="services.html">Green Energy</a> </h3>
                         </div>
                      </div>
                 ...
                 <div class="col-lg-3 col-md-6 col-sm-12">
                     <div class="services-box mb-30 text-center wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                         ...
                         <div class="text">
                            <h3> <a href="services.html">24/7 Premium Support</a> </h3>
                         </div>
                      </div>
                 ...
                 <div class="col-lg-5 col-md-12 col-sm-12">
                  ...
                  <div class="col-lg-7 col-md-12 col-sm-12">
                     <div class="s-about-img p-relative  wow fadeInLeft animated" data-animation="fadeInLeft" data-delay=".4s">
                         <img src="img/features/about_img_03.jpg" alt="img">
     ...
     <div class="container">
        <div class="row justify-content-center align-items-center center-align">
           <div class="col-lg-6 col-md-12">
              <div class="section-title text-center mb-20 wow fadeInDown  animated" data-animation="fadeInDown" data-delay=".4s">
                 <h5>What we grow</h5>
                 <h2>
                   Dcfarm Awesome & Fresh Products
                 </h2>
              </div>
           </div>
           </div>
         <div class="row align-items-center justify-content-center">
           <div class="col-lg-4">
                <div class="services-box-05 mb-30 hover-zoomin wow fadeInUp  animated" data-animation="fadeInUp" data-delay=".4s">
                    <div class="services-icon-05">
                        <a href="single-service.html"><img src="img/bg/services-08.jpg" alt="icon01"></a>
                    </div>
                    <div class="services-content-05">
                       <div class="icon">
                           <h4> <a href="single-service.html">Agriculture Products</a> </h4>
                       </div>
            ...
            <div class="col-lg-4">
                 <div class="services-box-05 mb-30 hover-zoomin wow fadeInUp  animated" data-animation="fadeInUp" data-delay=".4s">
                    <div class="services-icon-05">
                        <a href="single-service.html"><img src="img/bg/services-09.jpg" alt="icon01"></a>
                    </div>
                    <div class="services-content-05">
                       <div class="icon">
            ...
            <div class="col-lg-4">
                 <div class="services-box-05 mb-30 hover-zoomin wow fadeInUp  animated" data-animation="fadeInUp" data-delay=".4s">
                    <div class="services-icon-05">
                        <a href="single-service.html"><img src="img/bg/services-10.jpg" alt="icon01"></a>
                    </div>
                    <div class="services-content-05">
                       <div class="icon">
            ...
            <div class="col-lg-4">
                <div class="services-box-05 mb-30 hover-zoomin wow fadeInUp  animated" data-animation="fadeInUp" data-delay=".4s">
                    <div class="services-icon-05">
                        <a href="single-service.html"><img src="img/bg/services-11.jpg" alt="icon01"></a>
                    </div>
                    <div class="services-content-05">
                       <div class="icon">
           ...
           <div class="col-lg-4">
                 <div class="services-box-05 mb-30 hover-zoomin wow fadeInUp  animated" data-animation="fadeInUp" data-delay=".4s">
                    <div class="services-icon-05">
                        <a href="single-service.html"><img src="img/bg/services-05.jpg" alt="icon01"></a>
                    </div>
                    <div class="services-content-05">
                       <div class="icon">
            ...
            <div class="col-lg-4">
                <div class="services-box-05 mb-30 hover-zoomin wow fadeInUp  animated" data-animation="fadeInUp" data-delay=".4s">
                    <div class="services-icon-05">
                        <a href="single-service.html"><img src="img/bg/services-13.jpg" alt="icon01"></a>
                    </div>
                    <div class="services-content-05">
                       <div class="icon">
             ...
             <div class="row align-items-center">
                 ...
                 <div class="col-lg-6 col-md-12">
                     <div class="wow fadeInLeft animated" data-animation="fadeInLeft" data-delay=".4s">
                         <img src="img/features/about_img_04.png" alt="class image">
                     </div>
                     ...
                     <ul>
                         <li>
                             <div class="step-box wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                                 <div class="dnumber">
                                     <div class="date-box"><img src="img/icon/fea-icon04.png" alt="icon"></div>
                                 </div>
                                 <div class="text">
                         ...
                         <li>
                             <div class="step-box wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                                 <div class="dnumber">
                                      <div class="date-box"><img src="img/icon/fea-icon05.png" alt="icon"></div>
                                 </div>
                                 <div class="text">
                         ...
                         <li>
                             <div class="step-box wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                                 <div class="dnumber">
                                    <div class="date-box"><img src="img/icon/fea-icon06.png" alt="icon"></div>
                                 </div>
                                 <div class="text">
         ...
         <div class="container">
             <div class="portfolio ">
                 <div class="row align-items-end mb-50">
                     <div class="col-lg-12">
                          <div class="section-title text-center wow fadeInLeft  animated" data-animation="fadeInLeft" data-delay=".4s">
                   ...
                   <div class="row align-items-end mb-50">
                     <div class="col-lg-12">
                          <div class="my-masonry text-center wow fadeInRight  animated" data-animation="fadeInRight" data-delay=".4s">
                     ...
                     <div class="single-post2 hover-zoomin mb-30 wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                        <div class="blog-thumb2" style="height: 250px; overflow: hidden;">
                            <a href="{{ route('blog.show', ['blog' => $blog->id]) }}">
                                <img src="{{ asset('blog_images/' . $blog->image1) }}" alt="img" style="width: 100%; height: 100%; object-fit: cover;">
                            </a>
                        </div>
                         <div class="blog-content2">
                            ...
                            <div class="b-meta">
                             ...
                             <h4><a href="{{ route('blog.show', ['blog' => $blog->id]) }}">{!! substr(strip_tags($blog->title), 0, 25) !!}..</a></h4>
                             <p>{!! substr(strip_tags($blog->content), 0, 100) !!}</p>
                             <div class="blog-btn"><a href="{{ route('blog.show', ['blog' => $blog->id]) }}">Read More <i class="fal fa-long-arrow-right"></i></a></div>
                         </div>
                     </div>
                </div>
                @endforeach
