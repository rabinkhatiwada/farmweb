                                    ...
                                    <div class="breadcrumb-wrap">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">{{ $f->title }}
                                                </li>
                                            </ol>
                                        </nav>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="image-column col-xl-12 col-lg-12 col-md-12">
                                                @if ($f->y_url)
                                                    @php
                                                        $videoId = '';
                                                        parse_str(parse_url($f->y_url, PHP_URL_QUERY), $params);
                                                        if (isset($params['v'])) {
                                                            $videoId = $params['v'];
                                                        }
                                                    @endphp
                                                ...
                                                @elseif ($f->image1)
                                                    <figure class="image">
                                                        <img src="{{ asset('blog_images/' . $f->image1) }}" alt="{{ $f->title }}">
                                                    </figure>
                                                @endif
                                            </div>
